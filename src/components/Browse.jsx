  ...
  return (
    <Element name='browse'>
      ...
      <div className='flex flex-col md:grid gap-4 grid-cols-3 grid-rows-2 w-full '>
        ...
        {/* individual grids */}
        <div className='grid group overflow-hidden grid-cols-3 h-[15rem] lg:h-[17rem] bg-white rounded-2xl col-span-1 '>
          <div className='p-[1rem] group-hover: lg:p-[1.5rem] font-bold text-2xl'>Casual</div>
